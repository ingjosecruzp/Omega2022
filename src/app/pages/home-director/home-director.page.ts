import { Component, ElementRef, ViewChild, Renderer2, ɵCodegenComponentFactoryResolver, ViewContainerRef, ComponentFactoryResolver, ChangeDetectorRef } from '@angular/core';
...
*/
  ...
  */
  ...
  async changeSVG(){
    let escolaridad=this.getKeyToken("tipo").toLocaleLowerCase().replace(/\s/g, '_');
